...
document
  .getElementById("sb-menu-toggle")
  .addEventListener("click", function () {
    var sidebarMenu = document.getElementById("sb-sidebar-menu");
    sidebarMenu.classList.toggle("sb-active");
  });

document.getElementById("sb-close-btn").addEventListener("click", function () {
  var sidebarMenu = document.getElementById("sb-sidebar-menu");
  sidebarMenu.classList.remove("sb-active");
});
